...
function validateDatabaseName(databaseName) {
  if (typeof databaseName !== 'string')
    throw new MongoError({ message: 'database name must be a string', driver: true });
  if (databaseName.length === 0)
    throw new MongoError({ message: 'database name cannot be the empty string', driver: true });
